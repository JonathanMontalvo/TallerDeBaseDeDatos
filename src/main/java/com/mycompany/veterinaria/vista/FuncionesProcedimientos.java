...
import com.mycompany.veterinaria.vista.consultar.ConsultarFuncionesProcedimientos;
...
public class FuncionesProcedimientos extends javax.swing.JFrame
{
    ...
    public static int tipoFuncionProcedimiento;
    ...
    private void initComponents()
    {
        ...
        combo_FuncionesProcedimientos = new javax.swing.JComboBox<>();
        btn_Aceptar = new javax.swing.JButton();

        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        setTitle("Funciones y Procedimientos");
        ...
        combo_FuncionesProcedimientos.setFont(new java.awt.Font("Times New Roman", 1, 30)); // NOI18N
        combo_FuncionesProcedimientos.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Precios de inventarion sin IVA", "2", "3" }));
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(combo_FuncionesProcedimientos, 0, 615, Short.MAX_VALUE)
                .addContainerGap())
            .addGroup(layout.createSequentialGroup()
                .addGap(246, 246, 246)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(combo_FuncionesProcedimientos, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(35, 35, 35)
    ...
    {//GEN-HEADEREND:event_btn_AceptarActionPerformed
        ...
        tipoFuncionProcedimiento = combo_FuncionesProcedimientos.getSelectedIndex();
        ConsultarFuncionesProcedimientos cFP = new ConsultarFuncionesProcedimientos();
        switch (tipoFuncionProcedimiento)
        {
            case 0:
                cFP.setVisible(true);
                break;
            ...
            case 2:
                ...
                break;
            default:
                JOptionPane.showMessageDialog(this, "OCURRIO UN ERROR 140" + tipoFuncionProcedimiento, "Error", JOptionPane.ERROR_MESSAGE);
                break;
        }
        this.dispose();
    ...
    private javax.swing.JComboBox<String> combo_FuncionesProcedimientos;
